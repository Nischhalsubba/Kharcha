...
const s=StyleSheet.create({title:{color:COLORS.text,fontSize:18,fontWeight:'800',marginTop:24,marginBottom:10},grid:{flexDirection:'row',flexWrap:'wrap',gap:10},card:{width:'48%',minHeight:118,backgroundColor:COLORS.surface,borderRadius:18,borderWidth:1,borderColor:COLORS.border,padding:14,justifyContent:'space-between'},kicker:{color:COLORS.accent,fontSize:9,fontWeight:'800',letterSpacing:.8},big:{color:COLORS.text,fontSize:19,fontWeight:'900'},date:{color:COLORS.text,fontSize:14,fontWeight:'800',lineHeight:20},meta:{color:COLORS.muted,fontSize:11,lineHeight:16}});
