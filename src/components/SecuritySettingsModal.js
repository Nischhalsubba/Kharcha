...
const s=StyleSheet.create({
  ...
  section:{backgroundColor:COLORS.surface2,borderRadius:18,padding:15,marginTop:14},dangerSection:{borderWidth:1,borderColor:'#F3B7B7'},
  sectionTitle:{color:COLORS.text,fontSize:15,fontWeight:'900'},dangerTitle:{color:COLORS.danger,fontSize:15,fontWeight:'900'},
  label:{color:COLORS.text,fontSize:12,fontWeight:'800',marginTop:13,marginBottom:6},
  input:{height:48,borderRadius:14,borderWidth:1,borderColor:COLORS.border,backgroundColor:COLORS.surface,color:COLORS.text,paddingHorizontal:12,fontSize:17,letterSpacing:4},
  meta:{color:COLORS.muted,fontSize:12,lineHeight:17,marginTop:4},
  primary:{height:50,borderRadius:14,backgroundColor:COLORS.accent,alignItems:'center',justifyContent:'center',marginTop:16},primaryText:{color:COLORS.onAccent,fontWeight:'900'},
  secondary:{height:48,borderRadius:14,borderWidth:1,borderColor:COLORS.border,backgroundColor:COLORS.surface,alignItems:'center',justifyContent:'center',marginTop:14},secondaryText:{color:COLORS.text,fontWeight:'800'},
  switchRow:{flexDirection:'row',alignItems:'center',gap:12,marginTop:10},switchCopy:{flex:1},rowTitle:{color:COLORS.text,fontSize:14,fontWeight:'800'},
  timeoutGrid:{gap:8,marginTop:12},timeout:{minHeight:44,borderRadius:12,borderWidth:1,borderColor:COLORS.border,backgroundColor:COLORS.surface,justifyContent:'center',paddingHorizontal:12},timeoutActive:{borderColor:COLORS.accent,backgroundColor:COLORS.accentSoft},timeoutText:{color:COLORS.muted,fontWeight:'700'},timeoutTextActive:{color:COLORS.accent,fontWeight:'900'},
  dangerButton:{height:48,borderRadius:14,backgroundColor:COLORS.danger,alignItems:'center',justifyContent:'center',marginTop:12},dangerButtonText:{color:'#FFFFFF',fontWeight:'900'},
  note:{backgroundColor:COLORS.surface2,borderRadius:14,padding:12,marginTop:14},noteText:{color:COLORS.muted,fontSize:11,lineHeight:16},
