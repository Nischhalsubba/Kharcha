...
const s=StyleSheet.create({
  head:{flexDirection:'row',justifyContent:'space-between',alignItems:'center',marginTop:24,marginBottom:10},title:{color:COLORS.text,fontSize:16,lineHeight:24,fontWeight:'600'},link:{color:COLORS.accent,fontSize:12,fontWeight:'600'},withdraw:{color:COLORS.income,fontSize:12,fontWeight:'600'},success:{color:COLORS.accent,fontSize:12,fontWeight:'600'},
  list:{backgroundColor:COLORS.surface,borderRadius:12,borderWidth:1,borderColor:COLORS.border,overflow:'hidden'},item:{padding:14,borderBottomWidth:1,borderBottomColor:COLORS.border},between:{flexDirection:'row',justifyContent:'space-between',alignItems:'center'},copy:{flex:1},itemTitle:{color:COLORS.text,fontSize:14,fontWeight:'600'},meta:{color:COLORS.muted,fontSize:12,lineHeight:17,marginTop:4},percent:{color:COLORS.text,fontSize:15,fontWeight:'600'},track:{height:6,borderRadius:99,backgroundColor:COLORS.surface2,overflow:'hidden',marginTop:10},fill:{height:'100%',backgroundColor:COLORS.accent,borderRadius:99},actions:{flexDirection:'row',gap:16,alignItems:'center',marginTop:10},empty:{color:COLORS.muted,backgroundColor:COLORS.surface,borderRadius:12,borderWidth:1,borderColor:COLORS.border,padding:16,fontSize:13},
});
