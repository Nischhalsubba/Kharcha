...
const s=StyleSheet.create({
  ...
  block:{marginTop:12},
  card:{flexDirection:'row',gap:12,alignItems:'center',backgroundColor:COLORS.surface2,borderRadius:12,padding:14},
  icon:{fontSize:22},copy:{flex:1},cardTitle:{color:COLORS.text,fontSize:14,fontWeight:'600'},meta:{color:COLORS.muted,fontSize:12,lineHeight:17,marginTop:3},
  primary:{height:48,borderRadius:10,backgroundColor:COLORS.accent,alignItems:'center',justifyContent:'center',marginTop:8},
  primaryText:{color:COLORS.onAccent,fontWeight:'600'},
  secondary:{height:48,borderRadius:10,borderWidth:1,borderColor:COLORS.border,backgroundColor:COLORS.surface,alignItems:'center',justifyContent:'center',marginTop:8},
  secondaryText:{color:COLORS.text,fontWeight:'600'},
  warning:{flexDirection:'row',gap:9,backgroundColor:COLORS.surface2,borderRadius:10,padding:12,marginTop:16},
