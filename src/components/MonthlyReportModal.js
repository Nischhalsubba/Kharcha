...
const s=StyleSheet.create({
  ...
  title:{color:COLORS.text,fontSize:22,fontWeight:'600'},muted:{color:COLORS.muted,fontSize:13,lineHeight:19,marginTop:4},label:{color:COLORS.text,fontSize:12,fontWeight:'600',marginTop:16,marginBottom:7},
  input:{height:48,borderRadius:10,borderWidth:1,borderColor:COLORS.border,backgroundColor:COLORS.surface2,color:COLORS.text,paddingHorizontal:12},info:{backgroundColor:COLORS.surface2,borderRadius:10,padding:12,marginTop:16},infoText:{color:COLORS.muted,fontSize:11,lineHeight:17},
