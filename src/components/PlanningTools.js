...
const s=StyleSheet.create({
  head:{flexDirection:'row',justifyContent:'space-between',alignItems:'flex-end',marginTop:24,marginBottom:10},kicker:{color:COLORS.accent,fontSize:9,fontWeight:'800',letterSpacing:1},title:{color:COLORS.text,fontSize:18,fontWeight:'800',marginTop:4},link:{color:COLORS.accent,fontSize:12,fontWeight:'800'},
  summary:{minHeight:102,backgroundColor:COLORS.surface,borderRadius:18,borderWidth:1,borderColor:COLORS.border,padding:15,flexDirection:'row',justifyContent:'space-between',alignItems:'center',marginBottom:10},big:{color:COLORS.text,fontSize:20,fontWeight:'900'},meta:{color:COLORS.muted,fontSize:12,lineHeight:17,marginTop:4},danger:{color:COLORS.danger},right:{alignItems:'flex-end'},
  list:{backgroundColor:COLORS.surface,borderRadius:18,borderWidth:1,borderColor:COLORS.border,overflow:'hidden'},item:{minHeight:72,padding:14,flexDirection:'row',justifyContent:'space-between',alignItems:'center',borderBottomWidth:1,borderBottomColor:COLORS.border},copy:{flex:1},itemTitle:{color:COLORS.text,fontSize:14,fontWeight:'800'},empty:{color:COLORS.muted,padding:16,fontSize:13},
});
